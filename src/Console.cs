...
[assembly: Convention(Target = ConventionTarget.Member, Member = ConventionMember.All , Notation = Notation.CamelCase)]
...
namespace DotNetConsoleJS
{
    ...
    public static class Console
    {
        ...
        public extern static bool IsInputRedirected { get; }
        //
        // Summary:
        ...
        public extern static int BufferHeight { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int BufferWidth { get; set; }
        //
        // Summary:
        ...
        public extern static bool CapsLock { get; }
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static int CursorLeft { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int CursorSize { get; set; }
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static int CursorTop { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The get operation is invoked on an operating system other than Windows.
        public extern static bool CursorVisible { get; set; }
        //
        // Summary:
        ...
        public extern static TextWriter Error { get; }
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static ConsoleColor ForegroundColor { get; set; }
        //
        // Summary:
        ...
        public extern static TextReader In { get; }
        //
        // Summary:
        ...
        public extern static Encoding InputEncoding { get; set; }
        //
        // Summary:
        ...
        public extern static bool IsErrorRedirected { get; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int WindowWidth { get; set; }
        //
        // Summary:
        ...
        public extern static bool IsOutputRedirected { get; }
        //
        // Summary:
        ...
        public extern static bool KeyAvailable { get; }
        //
        // Summary:
        ...
        public extern static int LargestWindowHeight { get; }
        //
        // Summary:
        ...
        public extern static int LargestWindowWidth { get; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The get operation is invoked on an operating system other than Windows.
        public extern static bool NumberLock { get; }
        //
        // Summary:
        ...
        public extern static TextWriter Out { get; }
        //
        // Summary:
        ...
        //   T:System.Security.SecurityException:
        //     Your application does not have permission to perform this operation.
        public extern static Encoding OutputEncoding { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The get operation is invoked on an operating system other than Windows.
        public extern static string Title { get; set; }
        //
        // Summary:
        ...
        public extern static bool TreatControlCAsInput { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int WindowHeight { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int WindowLeft { get; set; }
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The set operation is invoked on an operating system other than Windows.
        public extern static int WindowTop { get; set; }
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static ConsoleColor BackgroundColor { get; set; }
        ...
        public extern static event ConsoleCancelEventHandler CancelKeyPress;
        ...
        public extern static void Beep();
        //
        // Summary:
        ...
        public extern static void Beep(int frequency, int duration);
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The current operating system is not Windows.
        public extern static void MoveBufferArea(int sourceLeft, int sourceTop, int sourceWidth, int sourceHeight, int targetLeft, int targetTop);
        //
        // Summary:
        //     Copies a specified source area of the screen buffer to a specified destination
        //     area.
        ...
        //   T:System.PlatformNotSupportedException:
        //     The current operating system is not Windows.
        public extern static void MoveBufferArea(int sourceLeft, int sourceTop, int sourceWidth, int sourceHeight, int targetLeft, int targetTop, char sourceChar, ConsoleColor sourceForeColor, ConsoleColor sourceBackColor);
        //
        // Summary:
        ...
        public extern static Stream OpenStandardError(int bufferSize);
        //
        // Summary:
        ...
        // Returns:
        //     The standard error stream.
        public extern static Stream OpenStandardError();
        //
        // Summary:
        ...
        //   T:System.ArgumentOutOfRangeException:
        //     bufferSize is less than or equal to zero.
        public extern static Stream OpenStandardInput(int bufferSize);
        //
        // Summary:
        ...
        // Returns:
        //     The standard input stream.
        public extern static Stream OpenStandardInput();
        //
        // Summary:
        ...
        //   T:System.ArgumentOutOfRangeException:
        //     bufferSize is less than or equal to zero.
        public extern static Stream OpenStandardOutput(int bufferSize);
        //
        // Summary:
        ...
        // Returns:
        //     The standard output stream.
        public extern static Stream OpenStandardOutput();
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static Task<int> Read();
        //
        // Summary:
        ...
        //     console.
        public extern static Task<ConsoleKeyInfo> ReadKey(bool intercept);
        //
        // Summary:
        //     Obtains the next character or function key pressed by the user. The pressed key
        ...
        //     The System.Console.In property is redirected from some stream other than the
        //     console.
        public extern static Task<ConsoleKeyInfo> ReadKey();
        //
        // Summary:
        ...
        public extern static Task<string> ReadLine();
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void ResetColor();
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The current operating system is not Windows.
        public extern static void SetBufferSize(int width, int height);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void SetCursorPosition(int left, int top);
        //
        // Summary:
        ...
        public extern static void SetError(TextWriter newError);
        //
        // Summary:
        ...
        //   T:System.Security.SecurityException:
        //     The caller does not have the required permission.
        public extern static void SetIn(TextReader newIn);
        //
        // Summary:
        ...
        //   T:System.Security.SecurityException:
        //     The caller does not have the required permission.
        public extern static void SetOut(TextWriter newOut);
        //
        // Summary:
        ...
        //   T:System.PlatformNotSupportedException:
        //     The current operating system is not Windows.
        public extern static void SetWindowPosition(int left, int top);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(ulong value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(bool value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(char value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(double value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(long value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(object value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(float value);
        //
        // Summary:
        ...
        public extern static void Write(string format, object arg0);
        //
        // Summary:
        ...
        //   T:System.FormatException:
        //     The format specification in format is invalid.
        public extern static void Write(string format, object arg0, object arg1);
        //
        // Summary:
        //     Writes the text representation of the specified objects to the standard output
        //     stream using the specified format information.
        ...
        //   T:System.FormatException:
        //     The format specification in format is invalid.
        public extern static void Write(string format, object arg0, object arg1, object arg2);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(uint value);
        //
        // Summary:
        ...
        //   T:System.IO.IOException:
        //     An I/O error occurred.
        public extern static void Write(decimal value);
        //
        // Summary:
        ...
        //   T:System.FormatException:
        //     The format specification in format is invalid.
        public extern static void WriteLine(string format, object arg0);
        //
        // Summary:
        ...
        //   T:System.FormatException:
        //     The format specification in format is invalid.
        public extern static void WriteLine(string format, object arg0, object arg1);
        //
        // Summary:
        //     Writes the text representation of the specified objects, followed by the current
        //     line terminator, to the standard output stream using the specified format information.
        ...
        //   T:System.FormatException:
        //     The format specification in format is invalid.
        public extern static void WriteLine(string format, object arg0, object arg1, object arg2);
        //
        // Summary:
